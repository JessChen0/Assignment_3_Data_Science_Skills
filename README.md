...
Pattern Recognition: Crafting and testing complex Regular Expressions to identify specific character sequences (palindromes, repeated characters, and HTML tags).

Data Integrity: Identifying hidden structures in messy data to ensure accuracy for downstream modeling.
...
Data Auditing: Using Regex to scan massive datasets for sensitive information or non-compliant formatting.

Standardization: Developing "rules of the road" for how unstructured public data (like government records) should be parsed and documented.

Automated Documentation: Creating scripts that can automatically identify and categorize data types within a catalog.

📁 File Structure
Assignment_3_Data_Science_Skills.Rmd: The primary R Markdown script containing the code, regex explanations, and output.

Assignment_3_Data_Science_Skills.html: A rendered report for easy viewing of the analysis and finding
